...
export default function Title({
  ...
  return (
    <div className="py-2">
      <h1 className="text-3xl text-center font-bold text-clip w-fit mx-auto flex gap-3 mb-2">
        <span className="text-clip-1 pt-1">{iconTitle}</span> {title}
        <span className="text-clip-2 pt-1">{iconTitle}</span>
      </h1>
      {subtitle && (
        <h2 className="text-xl text-center text-clip w-fit mx-auto flex gap-3 mb-4">
